var DE_MESSAGES = {
  ...
  settingsDefaultActionCopyTagIdClass: "tag#id.class kopieren",
  ...
  settingsDefaultActionCopyQaDetails: "QA-Details kopieren",
  ...
  tabAbout: "ÜBER",
  tabRecommend: "EMPFEHLEN",
  recommendIntro: "Wenn die Erweiterung jemand anderem helfen könnte, teilen Sie den Link. Wenn sie Ihnen gefällt, können Sie sie im Store bewerten.",
  recommendOpenAction: "Seite öffnen",
  recommendCopyAction: "Link kopieren",
  recommendShareAction: "Teilen",
  recommendShareMessage: "Diese Erweiterung könnte für Sie nützlich sein.",
  recommendCopied: "Link kopiert",
  recommendCopyFailed: "Link konnte nicht kopiert werden",
  recommendShareFailed: "Teilen konnte nicht geöffnet werden",
  ...
  welcomePinStep1: "Öffne in der oberen Leiste die Erweiterungsliste",
  welcomePinStep2: "Suche in der Liste:",
  welcomePinStep3: "Klicke auf die Anheften-Schaltfläche:",
  aboutBullets: [
    "In die Zwischenablage kopieren oder herunterladen",
    "Merkt sich die letzten Aufnahmen",
