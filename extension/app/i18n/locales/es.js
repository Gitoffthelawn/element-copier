var ES_MESSAGES = {
  ...
  settingsDefaultActionCopyTagIdClass: "Copiar tag#id.class",
  ...
  settingsDefaultActionCopyQaDetails: "Copiar detalles de QA",
  ...
  formatQaDetails: "detalles de QA",
  formatText: "Texto",
  ...
  tabAbout: "ACERCA DE",
  tabRecommend: "RECOMENDAR",
  recommendIntro: "Si la extensión puede ser útil para otra persona, comparte el enlace. Si te gusta, puedes valorarla en la tienda.",
  recommendOpenAction: "Abrir página",
  recommendCopyAction: "Copiar enlace",
  recommendShareAction: "Compartir",
  recommendShareMessage: "Esta extensión puede resultarte útil.",
  recommendCopied: "Enlace copiado",
  recommendCopyFailed: "No se pudo copiar el enlace",
  recommendShareFailed: "No se pudo abrir el menú para compartir",
