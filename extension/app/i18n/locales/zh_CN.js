var ZH_CN_MESSAGES = {
  ...
  tabAbout: "关于",
  tabRecommend: "推荐",
  recommendIntro: "如果这个扩展程序可能对其他人有用，请分享链接。如果您喜欢它，也可以在商店中评分。",
  recommendOpenAction: "打开页面",
  recommendCopyAction: "复制链接",
  recommendShareAction: "分享",
  recommendShareMessage: "这个扩展程序可能对您有用。",
  recommendCopied: "链接已复制",
  recommendCopyFailed: "无法复制链接",
  recommendShareFailed: "无法打开分享功能",
