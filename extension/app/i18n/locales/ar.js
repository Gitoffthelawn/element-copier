var AR_MESSAGES = {
  ...
  settingsDefaultActionCopyTagIdClass: "نسخ tag#id.class",
  ...
  settingsDefaultActionCopyQaDetails: "نسخ تفاصيل QA",
  ...
  tabRecommend: "التوصية",
  recommendIntro: "إذا كانت الإضافة قد تفيد شخصًا آخر، فشارك الرابط. وإذا أعجبتك، يمكنك تقييمها في المتجر.",
  recommendOpenAction: "فتح الصفحة",
  recommendCopyAction: "نسخ الرابط",
  recommendShareAction: "مشاركة",
  recommendShareMessage: "قد تكون هذه الإضافة مفيدة لك.",
  recommendCopied: "تم نسخ الرابط",
  recommendCopyFailed: "تعذر نسخ الرابط",
  recommendShareFailed: "تعذر فتح المشاركة",
