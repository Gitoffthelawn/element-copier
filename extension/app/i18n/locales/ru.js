var RU_MESSAGES = {
  ...
  settingsDefaultActionCopyTagIdClass: "Копировать tag#id.class",
  ...
  settingsDefaultActionCopyQaDetails: "Копировать QA details",
  ...
  tabRecommend: "РЕКОМЕНДОВАТЬ",
  recommendIntro: "Если расширение может быть полезно кому-то ещё, поделитесь ссылкой. Если вам нравится расширение, вы можете оставить оценку в магазине.",
  recommendOpenAction: "Открыть страницу",
  recommendCopyAction: "Копировать ссылку",
  recommendShareAction: "Поделиться",
  recommendShareMessage: "Возможно, это расширение будет вам полезно.",
  recommendCopied: "Ссылка скопирована",
  recommendCopyFailed: "Не удалось скопировать ссылку",
  recommendShareFailed: "Не удалось открыть меню отправки",
  aboutPageTitle: "ELEMENT COPIER",
  aboutOverviewHeading: "Обзор",
  aboutCapabilitiesHeading: "Возможности",
  ...
  aboutBullets: [
    "Копирование в буфер обмена или скачивание",
    "Запоминает недавние снимки",
    "Тексты: форматированный, обычный, markdown, HTML",
  ...
  aboutCopiedElements: "Всего скопировано элементов: {count}",
