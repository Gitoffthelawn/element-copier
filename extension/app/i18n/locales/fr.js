var FR_MESSAGES = {
  ...
  settingsDefaultActionCopyTagIdClass: "Copier tag#id.class",
  ...
  settingsDefaultActionCopyQaDetails: "Copier les détails QA",
  ...
  tabAbout: "À PROPOS",
  tabRecommend: "RECOMMANDER",
  recommendIntro: "Si l’extension peut être utile à quelqu’un, partagez le lien. Si elle vous plaît, vous pouvez la noter dans le store.",
  recommendOpenAction: "Ouvrir la page",
  recommendCopyAction: "Copier le lien",
  recommendShareAction: "Partager",
  recommendShareMessage: "Cette extension pourrait vous être utile.",
  recommendCopied: "Lien copié",
  recommendCopyFailed: "Impossible de copier le lien",
  recommendShareFailed: "Impossible d’ouvrir le partage",
  ...
  aboutBullets: [
    "Copier dans le presse-papiers ou télécharger",
