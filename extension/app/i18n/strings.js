...
var EN_MESSAGES = {
  ...
  settingsDefaultActionCopyTagIdClass: "Copy tag#id.class",
  ...
  settingsDefaultActionCopyQaDetails: "Copy QA details",
  ...
  recommendOpenAction: "Open page",
  recommendCopyAction: "Copy link",
  recommendShareAction: "Share",
  recommendShareMessage: "This extension may be useful to you.",
  recommendCopied: "Link copied",
  recommendCopyFailed: "Couldn't copy the link",
  recommendShareFailed: "Couldn't open sharing",
  ...
  aboutCopiedElements: "Total elements copied: {count}",
  supportSurveyUsefulQuestion: "Do you like the extension?",
  supportSurveyAskMeLater: "Ask me later",
  supportSurveyNeverAsk: "Never ask",
  supportSurveyYes: "Yes",
  supportSurveyNo: "No",
  supportSurveyThankYouTitle: "Thank you!\nYou can support the project",
