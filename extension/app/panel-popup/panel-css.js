export const PANEL_CSS = `.ec-panel-header,
.dd-panel-header {
  flex: 0 0 auto;
...
.ec-recommend-icon-button { position: relative; display: inline-flex; align-items: center; justify-content: center; width: 2.15rem; height: 2.15rem; margin: 0; padding: 0; border: none; border-radius: 0.4rem; color: #4b5563; background: transparent; cursor: pointer; }
.ec-recommend-icon-button svg { display: block; width: 1.1rem; height: 1.1rem; }
