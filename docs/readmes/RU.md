...
- Выбор любого родителя из полной DOM-цепочки через контекстное меню на странице
...
- Требуется Firefox 140+ из-за использования расширением свойства манифеста `data_collection_permissions`; Firefox v139 и ниже не поддерживаются.
- Firefox 140–148 поддерживают копирование и контекстное меню; повторное открытие popup после копирования требует Firefox 149+.
