...
- اختيار أي عنصر أب من سلسلة DOM الكاملة عبر قائمة السياق داخل الصفحة
...
- يتطلب Firefox 140+ لأن هذا الامتداد يستخدم خاصية البيان `data_collection_permissions`؛ ولا يدعم Firefox الإصدار 139 أو الإصدارات الأقدم.
- يدعم Firefox 140–148 النسخ وقائمة السياق؛ تتطلب إعادة فتح النافذة المنبثقة بعد النسخ Firefox 149+.
