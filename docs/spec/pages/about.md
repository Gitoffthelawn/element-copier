...
- Every content line uses a standard list bullet.
  ...
  - Capabilities: "Copy to clipboard or download"; select a parent element from the complete ancestor chain using the in-page context menu; existing snapshot, text, image, selector and style lines; "QA details for bug reports"
  - Privacy: existing data-transmission and data-collection lines
